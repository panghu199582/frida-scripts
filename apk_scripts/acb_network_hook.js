...
Java.perform(function() {
        ...
        try {
            ...
            if (HttpURLConnection) {
                ...
                HttpURLConnection.setRequestMethod.implementation = function(method) {
                    logger.log("[+] HttpURLConnection 设置方法: " + method);
                ...
                HttpURLConnection.connect.implementation = function() {
                    logger.log("[+] HttpURLConnection 连接");
                    return this.connect();
                };
        ...
        try {
            ...
            if (URL) {
                URL.openConnection.overload().implementation = function() {
                    logger.log("[+] URL.openConnection: " + this.toString());
                    return this.openConnection();
                };
                
                URL.openConnection.overload('java.net.Proxy').implementation = function(proxy) {
                    logger.log("[+] URL.openConnection(Proxy): " + this.toString());
    ...
    // 7. 尝试Hook Apache HttpClient (如果存在)
...
// 使用说明：
// 1. 将此脚本保存为 acb_network_hook.js
// 2. 使用Frida注入: frida -U -f mobile.acb.com.vn -l acb_network_hook.js
// 3. 脚本会自动检测应用使用的网络库并设置相应的Hook
// 4. 所有网络请求都会记录到 /sdcard/acb_network.log 